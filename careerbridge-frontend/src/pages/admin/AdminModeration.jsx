            ...
            <tbody>
              {pending.map((m, idx) => (
                <tr key={m.id} className="admin-row" style={{ animationDelay: `${idx * 0.04}s` }}>
                  ...
                  <td>{m.reason}</td>
                  <td>
                    <Btn variant="g" size="xs" onClick={() => window.open(`${import.meta.env.VITE_API_BASE_URL || 'https://careerbridge-backend-vw5s.onrender.com'}/uploads/resumes/${m.file}`, '_blank', 'noopener,noreferrer')}>
